...
namespace Autossential.Activities
{
    public sealed class Exit : NativeActivity
    {
        ...
        public Exit()
        {
            Constraints.Add(ActivityConstraints.CreateConstraint<Exit>(activity => activity is Container || activity is Iterate, Resources.Validation_ScopeErrorFormat($"({nameof(Container)} or ${nameof(Iterate)})")));
        }
